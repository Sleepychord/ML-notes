...
> $$(\forall x_0, \forall \lambda_0)D(\lambda_0) = \min\limits_x J(x,\lambda_0) \leq J(x_0, \lambda_0)\leq \max\limits_{\lambda,\lambda_j(j=m_1+1,...m_2) \geq 0}J(x_0,\lambda)= L(x_0)$$ 
